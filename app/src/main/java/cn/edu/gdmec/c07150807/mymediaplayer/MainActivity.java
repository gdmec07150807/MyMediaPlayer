package cn.edu.gdmec.c07150807.mymediaplayer;
...
//加载当前布局文件控件操作
        ...
        holder.addCallback(new  SurfaceHolder.Callback(){
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                //在这里我们知道MediaPlayer在当前的Surface中进行播放
                player.setDisplay(holder);
                //在指定了MediaPlayer播放的容器后，我们就可以使用prepare或者
                //prepareAsync来准备播放了
                player.prepareAsync();
            }
        ...
        //为了可以播放视频或者使用Camera预览。我们需要知道其Buffer类型
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case 1:
                    ...
                    String timStr2=allTime.toString();
                    //已播放时间
                    play_time.setText(timeStr.substring(timeStr.indexOf(":")+1));
                    //总时间
                    all_time.setText(timStr2.substring(timeStr.indexOf(":")+1));
                    int progressValue=0;
